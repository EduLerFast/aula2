...
print (f' salario bruto: {salariobruto} R$ IR ({salariodescontadoimpostoderenda}) : R$ INSS ({salariodescontadoinss}) R$ Sindicato ({salariodescontadosindicato}) :R$ Salario Liquido {salarioliquido} ')
